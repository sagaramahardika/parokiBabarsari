...
<div class="row mt">
    <div class="col-lg-12">
		...
		<div class="row">
          ...
          <tr>
						<th>Lingkungan 	</th>
						<td>: <?php echo $data['BaptisAnak']['lingkungan'] ?></td>
					</tr>
					<tr>
						<th>Kode Stasi 	</th>
          ...
          <tr>
						<th>Status Perkawinan Orangtua	</th>
						<td>: <?php echo $data['BaptisAnak']['status_perkawinan_ortu'] ?></td>
					</tr>
          <tr>
						<th>Tempat Perkawinan Orangtua	</th>
						<td>: <?php echo $data['BaptisAnak']['tempat_perkawinan_ortu'] ?></td>
					</tr>
          <tr>
						<th>Tanggal Perkawinan Orangtua	</th>
						<td>: <?php echo $data['BaptisAnak']['tanggal_perkawinan_ortu'] ?></td>
					</tr>
          <tr>
						<th>Alamat Orangtua	</th>
						<td>: <?php echo $data['BaptisAnak']['alamat_ortu'] ?></td>
					</tr>
          <tr>
						<th>Telp/HP Orangtua	</th>
						<td>: <?php echo $data['BaptisAnak']['telp_ortu'] ?></td>
					</tr>
          <tr>
						<th>Nama Baptis 	</th>
          ...
          <tr>
						<th>Nama Wali Baptis 	</th>
						<td>: <?php if($data['Baptis']['wali_baptis']){ echo $data['Baptis']['wali_baptis'];}else{ echo "-";} ?></td>
					</tr>
          <tr>
            <th>Penjamin 	</th>
            <td>: <?php if($data['BaptisAnak']['penjamin']){ echo $data['BaptisAnak']['penjamin'];}else{ echo "-";} ?></td>
          </tr>
          <tr>
