...
<div class="row mt">
    <div class="col-lg-12">
        ...
        <div class="form-group">
          ...
          ?>
          <div class="col-md-4">
            <input type="text" name="data[BaptisDarurat][tanggal_perkawinan]" placeholder=" Tanggal Perkawinan" id="tanggal_perkawinan" class="form-control datepicker" role="date" required="">
          </div>
        </div>
