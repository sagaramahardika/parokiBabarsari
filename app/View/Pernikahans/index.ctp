    ...
    <div class="col-lg-12">
		...
		<div class="row">
			...
			/*$idPria = $data['Pernikahan']['paroki_pria'];
 			...
 			<td> 	<?php if($idPas == 0) echo $data['Pernikahan']['nm_pasangan'];  else echo $namaUmat[$data['Pernikahan']['pasangan_id']]; ?></td>
 				<td>	<?php echo $data['Pernikahan']['tmppernikahan']; ?></td>
 				<td>	<?php echo date('d-m-Y',strtotime($data['Pernikahan']['tglpernikahan'])) ?></td>
 				<td>	<?php echo $data['Pernikahan']['romopernikahan']; ?></td>
 				...
 				<td>	<?php echo $data['Pernikahan']['libermat']; ?></td>
						</tr>
