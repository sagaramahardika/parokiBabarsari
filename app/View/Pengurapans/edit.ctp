...
<!-- 
				...
				<div class="form-group">
					...
					?>
					<div class="col-md-4">
			            <input type="text" name="data[Pengurapan][tanggal_penerimaan]" class="form-control datepicker input-xlarge" role="date" placeholder="Tanggal Penerimaan" readonly="" value="<?php echo $this->request->data['Pengurapan']['tanggal_penerimaan'] ?>"> 
			        </div>
					<label style="color:red">*</label>
				</div>
