...
$(document).ready(function(){
  ...
  $("#tambahSakramen").click(function(){
    ...
    $("tbody").append("<tr><input type='hidden' name='data[KematianSakramen][nama_sakramen][]' value=" + $namaSakramen +"><input type='hidden' name='data[KematianSakramen][pelayan_sakramen][]' value=" + $pelayanSakramen +"><td>" + $namaSakramen + "</td><td>" + $pelayanSakramen + "</td></tr>")
    ...
    <div class="col-lg-12">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
					...
					?>
          <div class="col-md-4">
            <input type="text" name="data[Kematian][tanggal_lahir]" id="tanggalLahir" class="form-control datepicker" role="date" readonly="">
          </div>
				</div>
        ...
        <div class="form-group">
					...
					?>
          <div class="col-md-4">
            <input type="text" name="data[Kematian][tanggal_meninggal]" id="tanggalMeninggal" class="form-control datepicker" role="date" readonly="">
          </div>
				</div>
        ...
        <div class="form-group">
					...
					?>
          <div class="col-md-4">
            <input type="text" name="data[Kematian][tanggal_pemakaman]" id="tanggalPemakaman" class="form-control datepicker" role="date" readonly="">
          </div>
				</div>
        ...
        <div class="form-group">
					...
					?>
          <div class="col-md-4">
            <input type="text" name="data[Kematian][tanggal_baptis]" id="tanggalBaptis" class="form-control datepicker" role="date" readonly="">
          </div>
				</div>
        ...
        <div class="modal-body">
          <form class="form-horizontal">
	      			<div class="form-group">
  					    ...
  					    <div class="col-sm-9">
  					       	<input id="namaSakramen" type="text" class="form-control">
  					    </div>
  				    </div>
  				    <div class="form-group">
  					    <label for="nama" class="col-sm-3 control-label">Pelayan Sakramen</label>
  					    <div class="col-sm-9">
  					       	<input id="pelayanSakramen" type="text" class="form-control">
  					    </div>
  				    </div>
		        </form>
        </div>
